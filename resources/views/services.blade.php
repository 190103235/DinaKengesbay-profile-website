...
<body>
	<div id="services">
		<h1 class="topic">Serv<span>i</span>ces</h1>
		<p class="description">Being a Computer Science graduate, student of Masters and a Geek I have a firm grip on Programming Concepts and Android Programming. My life is all about computer and its vast horizons, my aim is to ace them. Share your problem and get 100% accurate solution in low-price</p>
		...
		<div class="container">
			<div class="card" style="width: 250px"> 
				...
				<div class="card-body">
    				...
    				<p class="card-text">I will code android applications in android studio</p>
			...
			<div class="card" style="width: 250px"> 
				...
				<div class="card-body">
    				...
    				<p class="card-text">I will create websites for your business</p>
			...
			<div class="card" style="width: 250px"> 
				...
				<div class="card-body">
    				...
    				<p class="card-text">I will make and debug IOS applications</p>
    				<p class="price">starting at $5</p>
				</div>
			</div>
	</div>
	</div>
